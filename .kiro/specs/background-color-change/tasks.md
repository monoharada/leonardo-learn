...
- [ ] 3. コントラスト計算の拡張
- [ ] 3.1 背景色を引数として受け取るコントラスト計算を実装する
...
- [ ] 5. ビュー層の背景色対応
- [ ] 5.1 パレットビューに背景色セレクターを統合する
  - palette-view上部に背景色セレクターを配置
  - 背景色変更時にパレット全体の背景を更新
  - 各色スウォッチのコントラスト値を再計算して表示
